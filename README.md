...
<html lang="id">
  ...
  <body>
    <div id="gameContainer">
      ...
      <div class="controls">
        <button class="btn control-btn" data-key="ArrowLeft">◀️</button>
        <button class="btn control-btn" data-key="ArrowUp">⬆️</button>
        <button class="btn control-btn" data-key="ArrowRight">▶️</button>
      </div>
